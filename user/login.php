		...
		<div class="container-login100">
			<div class="wrap-login100">
				<form class="login100-form" action="../login.php" method="POST">
					...
					<div class="wrap-input100 rs1-wrap-input100 validate-input m-b-20" data-validate="Escriba el usuario">
						<input id="first-name" class="input100" type="email" name="correo" placeholder="Correo" required>
						<span class="focus-input100"></span>
					</div>

					<div class="wrap-input100 rs2-wrap-input100 validate-input m-b-20" data-validate="Escriba la contraseña">
					...
					<div class="w-full text-center">
						<a href="regitrar.php" class="txt3">
							Registrar
						</a>
					</div>
				</form>
